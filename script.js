...
const exhibits = {
  ...
  climatehaven: { accession: 'PROFESSIONAL COLLECTION / 004', title: 'ClimateHaven', visual: 'file', body: `<p>Reviewer experience represented as an archival review copy. Dates and responsibilities are intentionally left as placeholders until confirmed.</p>` },
  faa: { accession: 'CREDENTIAL COLLECTION / 001', title: 'FAA Remote Pilot Certificate', visual: 'certificate', body: `<p>Part 107 remote pilot credential. Certificate date, number, and supporting details can be added once supplied.</p><dl><dt>Type</dt><dd>Framed professional credential</dd></dl>` },
